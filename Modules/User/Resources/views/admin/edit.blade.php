    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form method="POST" action="{{ route('admin.user.update', $single->id) }}"
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="number" class="form-control" name="phone" placeholder="Telepon"
                                                value="{{ $single->phone }}">
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="gender" value="1"
                                                        {{ $single->gender == 1 ? 'checked' : '' }}> Laki - Laki
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="gender" value="2" {{ $single->gender == 2 ? 'checked' : '' }}> Perempuan
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="number" class="form-control" name="identity" placeholder="No. Identitas" value="{{ $single->identity }}">
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <select class="selectpicker" data-style="btn btn-primary btn-round"
                                                    ...
                                                    @foreach (['active', 'non-active'] as $status)
                                                        <option value="{{ $status }}" {{ $single->ref_status->title == $status ? "selected" : ""}}>{{ ucfirst($status) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <textarea type="text" class="form-control"
                                                    name="address">{{ $single->address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
