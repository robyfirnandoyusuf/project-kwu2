...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/frontend-assets/css/bootstrap.min.css">
    <link type="text/css" rel="stylesheet" href="/frontend-assets/css/magnific-popup.css">
    <link type="text/css" rel="stylesheet" href="/frontend-assets/css/jquery.selectBox.css">
    <link type="text/css" rel="stylesheet" href="/frontend-assets/css/dropzone.css">
    <link type="text/css" rel="stylesheet" href="/frontend-assets/css/rangeslider.css">
    <link type="text/css" rel="stylesheet" href="/frontend-assets/css/animate.min.css">
    ...
    <link type="text/css" rel="stylesheet" href="/frontend-assets/fonts/flaticon/font/flaticon.css">
                ...
                <div class="footer-item recent-posts">
                    ...
                    <div class="media mb-4">
                        <a href="properties-details.html">
                            <img src="/frontend-assets/img/sub-property/sub-property.jpg" alt="sub-property">
                        </a>
                    ...
                    <div class="media mb-4">
                        <a href="properties-details.html">
                            <img src="/frontend-assets/img/sub-property/sub-property-2.jpg" alt="sub-property-2">
                        </a>
                        <div class="media-body align-self-center">
                            <h5>
                    ...
                    <div class="media">
                        <a href="properties-details.html">
                            <img src="/frontend-assets/img/sub-property/sub-property-3.jpg" alt="sub-property-3">
                        </a>
                        <div class="media-body align-self-center">
                            <h5>
                            ...
                            <div id="modalCarousel" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="carousel-item">
                                        <img src="/frontend-assets/img/property/img-1.jpg" alt="Test ALT">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="/frontend-assets/img/property/img-1.jpg" alt="Test ALT">
                                    </div>
        ...
        <div class="off-canvas-content">
            <aside class="canvas-widget">
                <div class="logo-sitebar text-center">
                    <img src="/frontend-assets/img/logos/logo.png" alt="logo">
                </div>
            </aside>
            <aside class="canvas-widget">
                <ul class="menu">
...
<script src="/frontend-assets/js/jquery-2.2.0.min.js"></script>
<script src="/frontend-assets/js/popper.min.js"></script>
<script src="/frontend-assets/js/bootstrap.min.js"></script>
<script src="/frontend-assets/js/jquery.selectBox.js"></script>
<script src="/frontend-assets/js/rangeslider.js"></script>
<script src="/frontend-assets/js/jquery.magnific-popup.min.js"></script>
<script src="/frontend-assets/js/jquery.filterizr.js"></script>
<script src="/frontend-assets/js/wow.min.js"></script>
<script src="/frontend-assets/js/backstretch.js"></script>
<script src="/frontend-assets/js/jquery.countdown.js"></script>
<script src="/frontend-assets/js/jquery.scrollUp.js"></script>
...
<script src="/frontend-assets/js/jquery.mb.YTPlayer.js"></script>
<script src="/frontend-assets/js/leaflet.js"></script>
<script src="/frontend-assets/js/leaflet-providers.js"></script>
<script src="/frontend-assets/js/leaflet.markercluster.js"></script>
<script src="/frontend-assets/js/slick.min.js"></script>
<script src="/frontend-assets/js/maps.js"></script>
