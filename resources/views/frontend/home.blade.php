            ...
            <div class="col-lg-4 col-md-12 col-sm-12 wow fadeInRight delay-04s">
                <div class="media services-info">
                    ...
                    <div class="media-body">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the</p>
                        <h4>03</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="property-box-2">
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            ...
                            <div class="tag-for">For Sale</div>
                            <img src="/frontend-assets/img/property/img-8.jpg" alt="property-2" class="img-fluid">
                            <div class="info">
                                <ul class="facilities-list clearfix">
                                    <li>
                                        <i class="flaticon-square-layouting-with-black-square-in-east-area"></i>
                        ...
                        <div class="property-overlay">
                            ...
                            <div class="property-magnify-gallery">
                                <a href="/frontend-assets/img/property/img-8.jpg" class="overlay-link">
                                    <i class="fa fa-expand"></i>
                                </a>
                                <a href="/frontend-assets/img/property/img-9.jpg" class="hidden"></a>
                                <a href="/frontend-assets/img/property/img-7.jpg" class="hidden"></a>
                            </div>
                        </div>
                    </div>
                    <div class="detail">
                ...
                <div class="property-box-2">
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            ...
                            <div class="tag-for">For Sale</div>
                            <img src="/frontend-assets/img/property/img-9.jpg" alt="property-2" class="img-fluid">
                            <div class="info">
                                <ul class="facilities-list clearfix">
                                    <li>
                                        <i class="flaticon-square-layouting-with-black-square-in-east-area"></i>
                        ...
                        <div class="property-overlay">
                            ...
                            <div class="property-magnify-gallery">
                                <a href="/frontend-assets/img/property/img-9.jpg" class="overlay-link">
                                    <i class="fa fa-expand"></i>
                                </a>
                                <a href="/frontend-assets/img/property/img-8.jpg" class="hidden"></a>
                                <a href="/frontend-assets/img/property/img-7.jpg" class="hidden"></a>
                ...
                <div class="property-box-2">
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            ...
                            <div class="tag-for">For Sale</div>
                            <img src="/frontend-assets/img/property/img-10.jpg" alt="property-2" class="img-fluid">
                            <div class="info">
                                <ul class="facilities-list clearfix">
                                    <li>
                                        <i class="flaticon-square-layouting-with-black-square-in-east-area"></i>
                        ...
                        <div class="property-overlay">
                            ...
                            <div class="property-magnify-gallery">
                                <a href="/frontend-assets/img/property/img-10.jpg" class="overlay-link">
                                    <i class="fa fa-expand"></i>
                                </a>
                                <a href="/frontend-assets/img/property/img-9.jpg" class="hidden"></a>
                                <a href="/frontend-assets/img/property/img-8.jpg" class="hidden"></a>
                        ...
                        <div class="carousel-inner wow fadeInUp delay-04s">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                            <img src="/frontend-assets/img/avatar/avatar-2.jpg" alt="avatar-2" class="img-fluid rounded">
                                        </div>
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                            <img src="/frontend-assets/img/avatar/avatar.jpg" alt="avatar" class="img-fluid rounded">
                                        </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                        <p class="lead">
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                            <img src="/frontend-assets/img/avatar/avatar-3.jpg" alt="avatar-3" class="img-fluid rounded">
                                        </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                        <p class="lead">
                ...
                <div class="slick-slide-item">
                    <div class="blog-1">
                        <div class="blog-photo">
                            ...
                            <div class="user">
                                <div class="avatar">
                                    <img src="/frontend-assets/img/avatar/avatar-3.jpg" alt="avatar" class="img-fluid rounded-circle">
                                </div>
                                <div class="name">
                                    <h5>Teseira</h5>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12">
                <div class="intro-text">
                    <a href="index-2.html" class="logos"><img src="/frontend-assets/img/logos/logo-white.png" alt="logo"></a>
                    <a href="index-2.html" class="d-none-768"><img src="/frontend-assets/img/logos/logo-white.png" alt="logo"></a>
