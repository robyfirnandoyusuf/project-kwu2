$(function () {
    ...
    $(window).on('load', function () {
        ...
        setTimeout(function () {
            ...
            $('link[id="style_sheet"]').attr('href', '/frontend-assets/css/skins/default.css');
        }, 1000);
        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.logo img').attr('src', '/frontend-assets/img/logos/black-logo.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    $('.logo img').attr('src', '/frontend-assets/img/logos/logo.png');
                } else {
                    $('.logo img').attr('src', '/frontend-assets/img/logos/logo.png');
                }
            }
   ...
   $(".dropdown").on('hover', function () {
    ...
    $(document).on('click', '.color-plate', function () {
        ...
        $('link[id="style_sheet"]').attr('href', '/frontend-assets/css/skins/' + name + '.css');
    });
